...
//       setFiltered(tasks);
//     }else {
//       const filtrado = tasks.filter ( item => item.name && item.name.toLowerCase().includes(search.toLowerCase()))
...
//     // Here you might want to save the updated tasks back to AsyncStorage as well
